  ...
  <section class="intro section-padding">
    <div class="container">
      <div class="row lg-marg">
        <div class="col-lg-8 md-mb80">
          <div class="row lg-marg align-items-center">
            <div class="col-md-6">
              <div class="img1 sm-mb50">
            ...
            <div class="col-md-6">
              <div class="text">
                <h3 class="mb-30">
                  ...
                  <span class="fw-300">creativity.</span>
                </h3>
                <p>
                  We are a performance-driven digital marketing agency dedicated to
                  scaling your business through proven strategies and cutting-edge
                  technology.
                </p>

                <a href="/page-about" class="underline main-color mt-40">
                  <span class="text">
                    More About Us <i class="ti-arrow-top-right"></i>
                  </span>
                </a>
              </div>
            </div>
