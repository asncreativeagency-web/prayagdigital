        ...
        <div class="col-lg-6 offset-lg-1">
          <div class="item mb-30">
            <div class="row">
              ...
              <div class="col-md-8">
                <div class="info">
                  <h5 class="mb-15">Meta ads</h5>
                  <p>
                    Effective Facebook and Instagram ad campaigns to reach your target audience and boost engagement.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div class="item mb-30">
            <div class="row">
              ...
              <div class="col-md-8">
                <div class="info">
                  <h5 class="mb-15">Google ads</h5>
                  <p>
                    Strategic Google Ads management to drive traffic, increase conversions, and maximize ROI.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div class="item">
            <div class="row">
              ...
              <div class="col-md-8">
                <div class="info">
                  <h5 class="mb-15">Social Media handling</h5>
                  <p>
                    Comprehensive social media management to build brand awareness and foster community growth.
                  </p>
                </div>
              </div>
            </div>
